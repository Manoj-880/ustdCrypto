...
const TransactionDetails = ({ transaction }) => {
  ...
  const generatePDF = () => {
    ...
    const tableData = [
      ...
      ["Amount", `${transaction.amount.toFixed(2)} USDT`],
      ["Fee", `${transaction.fee.toFixed(2)} USDT`],
      ["Balance After", `${transaction.balance.toFixed(2)} USDT`],
      ["Status", transaction.status.toUpperCase()],
      ["Date", dayjs(transaction.date).format("MMM DD, YYYY HH:mm")],
    ...
    doc.text(
      `Generated by Alpha Wave • ${dayjs().format("MMM DD, YYYY HH:mm")}`,
      14,
      finalY + 6
    );

    // Save Download
    doc.save(`${transaction.id}_receipt.pdf`);
  };
