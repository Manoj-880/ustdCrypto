  ...
  depositSuccess: (userEmail, userName, amount, txId, date) => {
    return {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>Thank you for choosing SecureUSDT!</p>
      ...
      text: `
        ...
        Thank you for choosing SecureUSDT!
...
const sendEmail = async (toEmail, templateName, ...templateParams) => {
  try {
    ...
    const command = new SendEmailCommand({
      Source: 'payments@secureusdt.com', // Verified sender email
      Destination: {
        ToAddresses: [toEmail],
      },
      Message: {
...
const sendContactFormEmail = async (name, email, mobileNumber, subject, message) => {
  return await sendEmail(
    'payments@secureusdt.com', // Admin email (verified)
    'contactForm',
    [name, email, mobileNumber, subject, message]
  );
};
